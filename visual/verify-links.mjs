...
const SUBPAGES = [
  ...
  ["ax-engineer", "recruit/ax-engineer/index.html", ["AX 엔지니어", "사내 FDE", 'href="/#recruit"', "(채용 중)", "전형 절차 · 제출 서류 · 지원 문의", "제출 서류", "접수양식 링크(사람인)", "track-apply-form", "제출 방법", "불인정하오니", "채용 공고 보기(사람인)", "rec_idx=54573987", "postech-air@postech.ac.kr", "054-279-3501", "근무지 포항공과대학교"]],
];
try {
