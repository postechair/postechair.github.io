...
const SUBPAGES = [
  ...
  ["platform-lead", "recruit/platform-lead/index.html", ["AI 플랫폼 리드 엔지니어", "가속과 통제를 동시에 하는 일", 'href="/#recruit"', "mailto:postech-air@postech.ac.kr", "근무지 포항공과대학교", "채용 공고 확인(사람인) 및 지원하기", "rec_idx=54573987", "채용 일정", "8.6(목) 24:00", "서류심사 합격자 발표", "면접전형"]],
