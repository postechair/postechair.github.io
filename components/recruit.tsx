...
/** 채용 페이지 공용 상단바 — hub(전체 공고 페이지)에서는 자기 링크 생략 */
export function RecruitTopbar({ hub = false }: { hub?: boolean }) {
  return (
...
/** 센터 소개 — 두 공고가 공유하는 동일 원문 (JD §1) */
export function CenterIntroSection({ alt = false }: { alt?: boolean }) {
  return (
    <section className={"sec" + (alt ? " alt" : "")}>
      <div className="wrap">
        <h2 className="sech">센터 소개</h2>
