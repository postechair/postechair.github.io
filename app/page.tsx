...
const SOLUTIONS = [
  ...
  { k: "동문·발전기금", b: "구축중", t: "동문 통합 DB · 기부 관리", d: "동문 마스터 데이터와 발전기금·기부 관리를 위한 시스템입니다." },
  { k: "연구지원팀 IRIS 모니터링", b: "구축중", t: "연구행정 알림 자동화", d: "연구행정시스템(IRIS)의 회수금·연구비·제안서 현황을 매일 자동 수집해 담당자에게 이메일·Teams 알림을 제공하는 시스템입니다." },
  { k: "AP포럼 운영관리", b: "구축중", t: "포럼 회원·참석 관리", d: "AP포럼의 회원 정보와 초청·참석(RSVP) 현황을 관리하는 운영 시스템입니다." },
];
