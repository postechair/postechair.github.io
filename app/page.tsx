...
const SOLUTIONS = [
  ...
  { k: "직원업무관리", t: "업무 목표·실적 관리", d: "부서·개인의 업무 목표와 실적을 등록·관리하고 평가를 지원하는 시스템입니다." },
  { k: "공간관리", t: "캠퍼스 공간 정보·도면", d: "건물·실 단위 공간 정보와 도면을 관리하고 공간 활용 분석을 지원하는 시스템입니다." },
  { k: "대학규정통합관리", t: "규정 지식 구조화 (LLM Wiki)", d: "대학 규정을 agent-readable 지식으로 구조화해 규정 간 상충·경합·유사·위계 관계 분석과 유관 법령 개정 시 효력 영향 추적을 지원하는 시스템입니다." },
  ...
  { k: "연구지원팀 IRIS 모니터링", t: "연구행정 알림 자동화", d: "연구행정시스템(IRIS)의 회수금·연구비·제안서 현황을 매일 자동 수집해 담당자에게 이메일·Teams 알림을 제공하는 시스템입니다." },
  { k: "AP포럼 운영관리", t: "포럼 회원·참석 관리", d: "AP포럼의 회원 정보와 초청·참석(RSVP) 현황을 관리하는 운영 시스템입니다." },
];
