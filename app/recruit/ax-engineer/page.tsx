...
const MUST = [
  <><b>풀스택 개발 역량</b> — 백엔드·데이터·기본 프런트엔드를 아우르며, 하나의 솔루션을 <b>혼자 end-to-end로 완성</b>한 경험 (Python 중심, 예: FastAPI, PostgreSQL 등)</>,
  <><b>LLM/RAG/agent 기반 애플리케이션 구축 경험</b> — 또는 그에 준하는 강한 학습 의지와 이를 입증하는 포트폴리오</>,
  ...
  <>학력: 학사 이상 또는 동등한 실무 역량 — <b>경력 연수·학위보다 포트폴리오·실문제 해결 능력을 우선 평가</b> (신입/경력 무관, 고잠재력 주니어 지원 환영)</>,
];
      ...
      <main className="jd">
        ...
        <section className="sec alt">
          <div className="wrap">
            ...
            <p style={{ marginTop: 14 }}>AIR센터는 학내 행정업무를 AI 기반으로 전환(AX)하는 조직으로, <b>현업에 들어가 변화를 만드는 AX 엔지니어 파트</b>와 <b>그 변화를 뒷받침하면서 동시에 통제하는 AI 플랫폼 파트</b>의 2파트 체계로 운영됩니다. AX 엔지니어는 이 중 <b>현장 배포(forward)의 실행 주체</b>이며, 센터의 <b>현장 배포(딜리버리) 처리량을 확장</b>하기 위한 핵심 포지션입니다. 반복되는 작업을 재사용 자산으로 승격(제품화)하는 책임을 함께 가집니다.</p>
