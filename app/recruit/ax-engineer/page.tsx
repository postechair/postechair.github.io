...
const MUST = [
  <><b>풀스택 개발 역량 (백엔드·데이터·기본 프런트엔드)</b></>,
  <><b>LLM/RAG/agent 기반 애플리케이션 구축 경험</b></>,
  <><b>비개발 이해관계자와 협업하여 솔루션으로 전환한 경험</b></>,
  <><b>Linux · 컨테이너(Docker) 기반 개발·배포 기본 역량</b></>,
];

const NICE = [
  <><b>모호한 문제를 구조화한 경험</b></>,
  <><b>온프레미스 / 폐쇄망 / 자체 GPU 환경 구축·운영 경험</b></>,
  <><b>eval·관측(observability) 기반 LLM 시스템 품질 관리 경험</b></>,
  <><b>데이터 파이프라인(ELT), 벡터DB, 임베딩·리랭킹 운영 경험</b></>,
  <><b>agentic 개발 도구(Claude Code 등) 실무 활용</b></>,
  <><b>반복 작업을 재사용 자산으로 제품화한 경험</b></>,
  <><b>행정·공공·대학 도메인 또는 규제·보안 제약 환경 이해</b></>,
];
