...
const MUST = [
  <><b>상용 서비스·상품 개발 실무 경험</b></>,
  <><b>프로덕션 환경의 설계·구축·운영 경험</b></>,
  <><b>클라우드 인프라 및 컨테이너 기반 배포 체계 실무 경험</b></>,
  <><b>LLM 기반 시스템 구축 경험</b></>,
];

const NICE = [
  <><b>온프레미스 GPU 인프라 및 오픈소스 모델 서빙 경험</b></>,
  <><b>폐쇄망·망분리 환경에서의 개발·배포 경험</b></>,
  <><b>LLM 게이트웨이 / API 게이트웨이 및 관측(Observability) 체계 구축 경험</b></>,
  <><b>에이전틱 AI 시스템 설계·운영 경험. MCP 서버 구축 경험</b></>,
  <><b>Datalake 구축 경험</b></>,
  <><b>AI 코딩 에이전트를 팀 개발 프로세스에 도입·운영해 본 경험</b></>,
  <><b>공공·대학·규제 산업 도메인 이해</b></>,
];
