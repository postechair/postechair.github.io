        ...
        <section className="sec alt">
          <div className="wrap">
            ...
            <div className="callout">
              <p>이 포지션의 본질은 <b>가속과 통제를 동시에 하는 일</b>입니다. AX 엔지니어팀이 빠르게 만들고 빠르게 배포할 수 있도록 아키텍처·표준·자산을 공급(Support)하는 동시에, 무엇이 어디로 나가는지 항상 아는 상태를 유지(Control)해야 합니다.</p>
            </div>
          </div>
        </section>
